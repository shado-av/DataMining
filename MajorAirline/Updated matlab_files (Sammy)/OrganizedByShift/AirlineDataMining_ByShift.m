...
%% 
fileID2 = fopen('AMHaulData.csv', 'w');
fileID3 = fopen('PMHaulData.csv', 'w');
fileID4 = fopen('MIDHaulData.csv', 'w');
...
fprintf(fileID2,'Total Flights, Number Long Haul, Number Short Haul\n');
for i=1:AMdesks_num
    fprintf(fileID2,'%d,%d,%d\n', AM_numFlights(i), AM_longHaul(i),AM_shortHaul(i));
end
fprintf(fileID2,'\n %s \n',dist_AM_H);

fprintf(fileID3,'Total Flights, Number Long Haul, Number Short Haul\n');
for i=1:PMdesks_num
    fprintf(fileID3,'%d,%d,%d\n', PM_numFlights(i), PM_longHaul(i),PM_shortHaul(i));
end
fprintf(fileID3,'\n %s \n',dist_PM_H);
fprintf(fileID4,'Total Flights, Number Long Haul, Number Short Haul\n');
for i=1:MIDdesks_num
    fprintf(fileID4,'%d,%d,%d\n', MID_numFlights(i), MID_longHaul(i),MID_shortHaul(i));
end
fprintf(fileID4,'\n %s \n',dist_MID_H);
